# Firefox Add-ons (AMO) Listing Copy — v1.5.3
...
**Upload artifact:** `dist/aiauth-extension-firefox-v1.5.3.zip` (52 KB).
...
- [ ] Add-on package: `dist/aiauth-extension-firefox-v1.5.3.zip` (rebuild fresh with `python scripts/build-extension-zip.py --firefox` if there's any doubt).
